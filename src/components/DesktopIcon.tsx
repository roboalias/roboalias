...
const DesktopIcon = ({ icon: Icon, label, selected, onSelect, onOpen, infected = false }: DesktopIconProps) => {
  return (
    <button
      className={`flex flex-col items-center gap-1.5 p-3 rounded-none w-24 cursor-pointer select-none transition-colors ${
        selected
    ...
    >
      <div className="w-14 h-14 rounded-none bg-background/60 backdrop-blur-sm border border-border/40 flex items-center justify-center shadow-sm">
